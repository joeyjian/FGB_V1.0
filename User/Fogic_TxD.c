...
/* ============================================================================
   LED控制宏（共阳低有效，与原始完全一致）
   ============================================================================ */
#define SET_R(on)     do{ P05 = (on) ? 1 : 0; }while(0)   /* R -> P05, 共阴高有效 */
#define SET_G(on)     do{ P01 = (on) ? 1 : 0; }while(0)   /* G -> P01, 共阴高有效 */
#define SET_B(on)     do{ P06 = (on) ? 1 : 0; }while(0)   /* B -> P06, 共阴高有效 */
#define LED_ALL_OFF() do{ P05=0; P01=0; P06=0; }while(0)
